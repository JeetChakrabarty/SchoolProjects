	...
	public static void main(String[] args) {
		...
		if (!(args.length == 9)) {
			System.out.println("Incorrect number of arguments:" + args.length
					+ ", 9 needed");
			System.out
					.println("java Main2 <input image> <Red Threshold> <Green Threshold> <Blue Threshold> <maxLevl> <tree traversal method>");
			...
			System.out
					.println("Example: java Main2 lena.jpg  60.0 60.0 60.0 20.0 20.0 20.0 6 4");
			System.out
					.println("Example: java Main2 mando.jpg  60.0 60.0 60.0 20.0 20.0 20.0 6 4");
			System.exit(0);
		}
		...
		String segmented_filename = "segmented-level-" + args[7] + "-"
				+ mRedStg + "-" + mGreenStg + "-" + mBlueStg + "-" + sRedStg
				+ "-" + sGreenStg + "-" + sBlueStg + "-" + args[0];
		String painted_filename = "painted-level-" + args[7] + "-" + mRedStg
				+ "-" + mGreenStg + "-" + mBlueStg + "-" + sRedStg + "-"
				+ sGreenStg + "-" + sBlueStg + "-" + args[0];
		String sidewaysMerge2_filename = "sideways2-merging-" + args[7] + "-"
				+ mRedStg + "-" + mGreenStg + "-" + mBlueStg + "-" + sRedStg
				+ "-" + sGreenStg + "-" + sBlueStg + "-traversal-order-"
				+ args[8] + "-" + args[0];
		...
		// the root QuadNode and the maximum number of levels in the tree,
		// maxLevel
		QuadTree2 tree = new QuadTree2(pic, root, maxLevel, mRedT, mGreenT,
				mBlueT, sRedT, sGreenT, sBlueT);
		...
		System.out.println("\n\nStarting ");
		//Changed call on sidewwayMerge1 to sidewaysMerge2
		regionQueue = tree.sidewaysMerge2(regionQueue, sRedT, sGreenT, sBlueT);
		System.out.println("Finished sidewaysMerge1");
		System.out.println("\nStarting to draw each region");
		System.out.println(regionQueue.size() + " regions");
		...
		System.out.println("sideways2_filename=" + sidewaysMerge2_filename);
		pic3.show();
		pic3.save(sidewaysMerge2_filename);
